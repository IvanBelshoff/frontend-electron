...
type ConnectionDeleteConfirmDialogProps = {
  isOpen: boolean
...
export default function ConnectionDeleteConfirmDialog({
  isOpen,
  connectionName,
  isDeleting,
  error,
  onConfirm,
  onCancel,
}: ConnectionDeleteConfirmDialogProps) {
  return (
    <Dialog
      isOpen={isOpen}
    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-vscode-text">
          Confirma a exclusão da conexão <strong>{connectionName}</strong>?
        </p>
