...
import { hasActiveMyReportDialogFilters } from '@/features/my-reports/my-report-filters'
...
type MyReportsToolbarProps = {
  search: string
  onSearchChange: (value: string) => void
  filters: MyReportFilters
  onOpenFilters: () => void
  onToggleFavoritesFilter: () => void
  viewMode: MyReportViewMode
  onViewModeChange: (mode: MyReportViewMode) => void
}

export default function MyReportsToolbar({
  search,
  onSearchChange,
  filters,
  onOpenFilters,
  ...
  const hasDialogFilters = hasActiveMyReportDialogFilters(filters)
