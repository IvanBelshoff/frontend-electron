...
type DashboardDeleteConfirmDialogProps = {
  isOpen: boolean
...
export default function DashboardDeleteConfirmDialog({
  isOpen,
  dashboardName,
  isDeleting,
  error,
  onConfirm,
  onCancel,
}: DashboardDeleteConfirmDialogProps) {
  return (
    <Dialog
      isOpen={isOpen}
    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-vscode-text">
          Confirma a exclusão do dashboard <strong>{dashboardName}</strong>?
        </p>
