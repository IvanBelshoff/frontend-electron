...
export async function updateReportUserAiKnowledge(
  reportId: number,
  usuarioId: number,
  permitirConhecimentoIa: boolean,
): Promise<void> {
  await apiRequest<void>(`/relatorios/${reportId}/permitir-conhecimento-ia`, {
    method: 'PATCH',
    body: { usuarioId, permitirConhecimentoIa },
  })
}
